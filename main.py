...
text_1 = '<p>The image dimension ratio should be 1:1 for best result.</p>'
text_2 = '<p>The digit written by hand should be bold and large. Use thick marker for better result.</p>'
